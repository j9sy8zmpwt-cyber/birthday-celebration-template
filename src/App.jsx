    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Sonali ♥️]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Sonali's]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>You are the Pritiest Lady in this World 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [nhi Pata] 💖</h2>
          <p className="final-subtitle">Best of Luck for Your Exams Cutie ✨</p>
        </section>
      </div>
